...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "veerru-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/pasha"
  #   chef.validation_client_name = "pasha-validator"
  #   chef.validation_key_path = ".chef/pasha-validator.pem"
  # end
end
